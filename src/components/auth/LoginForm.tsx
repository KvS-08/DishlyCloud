...
export const LoginForm: React.FC<LoginFormProps> = ({ onShowRegister }) => {
  ...
  return (
    <div className={`w-full max-w-sm p-6 space-y-5 bg-white rounded-lg shadow-md dark:bg-gray-800 border border-primary-600 transition-opacity duration-500 ease-in ${isVisible ? 'opacity-10' : 'opacity-0'}`}>
